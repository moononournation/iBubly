...
const char input[] = "{\"WTS\":{\"name\":\"Thunderstorm Warning\",\"code\":\"WTS\",\"actionCode\":\"EXTEND\",\"issueTime\":\"2024-06-11T06:35:00+08:00\",\"expireTime\":\"2024-06-11T10:00:00+08:00\",\"updateTime\":\"2024-06-11T07:35:00+08:00\"}}";
...
void demoParse() {
  ...
  if (myObject.hasOwnProperty("WTS")) {
    Serial.print("myObject[\"WTS\"] = ");
    Serial.println(myObject["WTS"]);
    Serial.print("myObject[\"WTS\"][\"code\"] = ");
    Serial.println(myObject["WTS"]["code"]);
  }
